...
func Test_ParseTime(t *testing.T) {
	...
	assert.Equal(t, "Asia/Shanghai", local.String())

	r, local = ParseTime("2006-01-02", "2020-10-10", "Asia/Shanghai")
...
func Test_StartOfDate(t *testing.T) {
	...
	r = StartOfDate("2006-01-02", "2020-10-10", "Asia/Shanghai")
...
func Test_EndOfDate(t *testing.T) {
	...
	r = EndOfDate("2006-01-02", "2020-10-10", "Asia/Shanghai")
